...
--CREATE TABLE CAR AS
    ...
    --and bakery_security_logs.year = 2021 and bakery_security_logs.hour = 10 and bakery_security_logs.minute>15
...
SELECT BANK.passport_number , BANK.name , BANK.id, flights.id FROM BANK
join passengers on BANK.passport_number = passengers.passport_number
join flights on flights.id = passengers.flight_id
join airports on flights.origin_airport_id = airports.id
where airports.city = 'Fiftyville' and flights.year = 2021 and flights.month = 7 and flights.day = 29
